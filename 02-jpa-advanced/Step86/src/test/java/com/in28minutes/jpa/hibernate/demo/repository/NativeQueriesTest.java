...
public class NativeQueriesTest {
	...
	/*
	* If you are using a native query, it's on you to add the "is_deleted"
	* So if you are using native queries then you have to add the deleted condition by yourself.
	* */
